...
function getThingTemplate(things) {
  return "<li>".concat(things.Name, " - ").concat(things.Type, "</li>");
}
...
var things = data.Spirits.sort(sortMyStuff);
var content = "";
...
//# sourceMappingURL=/modern-javascript-002-SamGrant98.e31bb0bc.js.map